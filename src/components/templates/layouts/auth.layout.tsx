...
const AuthLayout = () => {
  return (
    <div className="bg-primary/10 flex min-h-svh min-w-svh p-4">
      <Card className="m-auto max-h-[80svh] w-full max-w-4xl flex-col gap-0 p-0 md:flex-row">
        <div className="h-20 overflow-hidden md:h-auto md:w-2/5">
          <img
            src={IlusAbstract}
        ...
        <CardContent className="flex flex-col items-start overflow-y-auto p-8 md:w-3/5 md:justify-center">
